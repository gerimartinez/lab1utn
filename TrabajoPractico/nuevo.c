...
void realizarDeposito(struct Cliente *cliente, float monto)
{
    ...
    (*cliente).operacionesRealizadas = (*cliente).operacionesRealizadas - 1;
}
...
void realizarTransferenciaEntreCuentas(struct Cliente clientes[], float monto)
{
    int montoTransferir, numeroCuentaTransferir, banderaCliente2, encontrado = 0, salirTransferencia = 0, i;
    ...
    do
    {
        ...
        for (i = 0; i < 10; i++)
        {
            if (clientes[i].numeroCuenta == numeroCuentaTransferir && clientes[i].numeroCuenta != clientes[banderaCliente].numeroCuenta && clientes[i].numeroCuenta < clientes[banderaCliente].numeroCuenta && clientes[i].numeroCuenta > clientes[banderaCliente].numeroCuenta)
            // if (clientes[i].numeroCuenta == numeroCuentaTransferir && clientes[i].numeroCuenta != clientes[banderaCliente].numeroCuenta && clientes[i].numeroCuenta < clientes[banderaCliente].numeroCuenta)
            {
                encontrado = 1;
                banderaCliente2 = i;
                break;
        ...
        if (encontrado == 0)
        {
                ...
                do
                {
                    printf("Si desea volver al menu ingrese: 1, en caso contrario ingrese 0\n");
                    scanf("%d", &salirTransferencia);
        ...
        else
        {
            ...
            clientes[banderaCliente].operacionesRealizadas = clientes[banderaCliente].operacionesRealizadas - 1;
        ...
        if (indiceCliente >= 0)
        {
            ...
            do
            {
                ...
                case 4:
                    ...
                    {
                        realizarTransferenciaEntreCuentas(&clientes[indiceCliente], monto);
                    }
                    break;
                case 5:
                    if ((*clientes).operacionesRealizadas <= 0)
